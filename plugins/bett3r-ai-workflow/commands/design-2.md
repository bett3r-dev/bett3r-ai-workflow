---
description: (experimental, v2 of /design) Grill the design to shared understanding while sharpening the domain model, then write a reviewable design doc. Constraint-shaped rewrite — same outputs, less procedure.
---

# /design-2 — grill + model the design
...
**This is the experimental v2 of `/design`.** It states what must be true and what must be produced, and leaves the procedure to you. If it underperforms `/design` on a real ticket, that is the finding — say so.
