...
| Multi | `/bett3r-ai-workflow:start-multi` | Fleet orchestrator: drive N work units through the flow **unattended**, one git worktree each — in parallel where safe, serially where not. Resumable; PRs opened ready for review. |
