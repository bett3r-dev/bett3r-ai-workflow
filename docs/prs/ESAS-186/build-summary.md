...
slices:
  ...
  - {id: 3, name: verify-build and merge-multi state the deferral contract and plugin bumped, origin: plan, mode: sequential, modeReason: pool=0, commit: aa66b33379283c5c59abe218f2d987555ba1a8a3, passed: true, attempts: 1, fixRounds: [], verifier: null, redBeforeGreen: true, postDesignDecisions: [D6]}
---
## What shipped
